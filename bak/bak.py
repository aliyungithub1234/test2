...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--thread', dest="max_threads", nargs='?', type=int, default=100, help="Max threads")
    ...
    try:
        if args.url:
            dispatcher(url=args.url, max_thread=args.max_threads)
        elif args.url_file:
            dispatcher(url_file=args.url_file, max_thread=args.max_threads)
        else:
